...
-- ============================================================
-- ETAPA 3.1: CORREÇÕES ESTRUTURAIS CRÍTICAS
-- ============================================================

-- ============================================================
-- 1) FUNÇÃO ATÔMICA PARA VERSIONAMENTO (sem race condition)
-- ============================================================
...
-- ============================================================
-- 2) CONSTRAINT: version_label único por protocolo
-- ============================================================

alter table protocol_versions
add constraint unique_protocol_version_label
unique (protocol_id, version_label);

-- ============================================================
-- 3) CONSTRAINT: DERIVED DEVE ter source_protocol_version_id
-- ============================================================

alter table protocols
add constraint derived_must_have_source_version
check (
  (protocol_type::text <> 'DERIVED')
  or (source_protocol_version_id is not null)
);
